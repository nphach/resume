...
\renewcommand{\section}[1]{\vspace{2.5mm}\noindent{\bfseries\large\color{accent} #1}\enspace\dfill\par}

\let\oldsubsection\subsection
\renewcommand{\subsection}[2]{\vspace{1.5mm}\noindent{\bfseries #1} \hfill #2\par\noindent}
...
\begin{document}
    ...
    \section{Projects}
        ...
        \begin{itemize}
            \item Designed a memorable portfolio experience by crafting a retro gadget UI in React/TypeScript.
            \item Enabled seamless animations with responsive geometry, SVG masks, and Motion transitions.
        \end{itemize}

        \subsection{Image Analysis: Skin Detection}{Spring 2024}
        \begin{itemize}
            \item Improved a skin detection pipeline from 73\% to 98\% accuracy by applying color-space analysis and dynamic thresholding, refactoring the core algorithm, and adding async image processing to~reduce~runtime.
    ...
    \section{Education}
        ...
        \noindent{\bfseries DeepLearning.AI, Stanford University}, Machine Learning: Regression and Classification \hfill January 2024\par
\end{document}